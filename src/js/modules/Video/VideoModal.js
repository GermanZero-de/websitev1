export default class VideoModal {
  constructor(videoElement) {
    ...
    if (holder) {
      ...
      this.containerElementFrameSelector = '.js-video-modal-frame';
  ...
  render(event) {
    if (this.isOpen) {
      ...
      const src = `https://www.youtube.com/embed/${id}${autoplay}${relatedNo}`;
      document.querySelector(this.containerElementFrameSelector).src = src;
    } else {
      document.querySelector(this.containerElementFrameSelector).src = '';
    }
